...
- 先讲清为什么今天值得放第一部分
- 默认优先加入**美投 5+2 分析法**，但把它当骨架，不要机械写成满屏 checklist
- 必须写亮点、风险、结论与依据边界
...
- 每只股票至少写出：**当日异动幅度（若有明显上涨/下跌必须写） / 为什么会有这次异动 / 具体新闻条目（新闻 1 / 2 / 3，写清标题或事件名 + 来源 + 内容） / 一句话总结 / 我的分析**
- 明确它影响的是经营层、平台层、资本结构层还是 thesis 本身
- 让读者一眼看出“为什么今天涨/跌这么多、触发点是什么、为什么重要、怎么解读、动作有没有变”
- **如果当天标的有明显异动，却没解释原因，视为这一模块不合格**
- **如果只给综合总结、没有把具体新闻条目列出来，也视为这一模块不合格**
- **不要把任何模块写成一堆一句话占位**
